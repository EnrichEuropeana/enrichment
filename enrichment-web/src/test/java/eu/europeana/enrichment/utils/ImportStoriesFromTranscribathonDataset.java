...
//
//        List<Story> listStoriesMinimal = objectMapper.readValue(responseStoriesMinimal,
//                new TypeReference<List<Story>>() {
//                });
//        if (listStoriesMinimal == null || listStoriesMinimal.isEmpty())
//            return;
//
//        for (Story minimalStory : listStoriesMinimal) {
//
//            String responseStoriesComplete = HelperFunctions.createHttpRequest(null,
//                    URLStoriesComplete + minimalStory.StoryId.toString(), null);
//
//            List<Story> listStoriesComplete = objectMapper.readValue(responseStoriesComplete,
//                    new TypeReference<List<Story>>() {
//                    });
//
...
//
//                String responseItemTranscription = HelperFunctions.createHttpRequest(null,
//                        URLItemTranscription + item.ItemId.toString(), null);
//                List<Transcription> listItemTranscription = objectMapper.readValue(responseItemTranscription,
//                        new TypeReference<List<Transcription>>() {
//                        });
...
//
//            if (!storyTranscription.equalsIgnoreCase(""))
