...
//		Path path = Paths.get("C:\\tmp\\story_description_language_mixed.csv");
...
//
//        List<String> allMatches = HelperFunctionsTest.findRegexpMatchesAndTextBetween(fileContent, regexAll);
//        return allMatches;
//	}
//}
