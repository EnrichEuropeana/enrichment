...
public class TranslationController extends BaseRest {
	...
	/**
         ...
         * @param property indicating the property which holds the original text (e.g. summary, description, transcription)
         * @return
         * @throws Exception 
         */
        @ApiOperation(value = "Submit corrected translation text for Items", nickname = "updateItemTranslation", 
                notes = "This method updates the translation of textual information available for transcribathon documents. \"storyId\" represents the identifier of the document in Transcribathon platform.\n" + 
                        " The parameter \"itemId\" further enables considering only specific story item. " +
        ...
        public ResponseEntity<String> updateItemTranslation(
                @PathVariable("storyId") String storyId,
                @PathVariable("itemId") String itemId,
                @RequestBody TranslationUpdateRequest  body,
                HttpServletRequest request) throws Exception {
                ...
                TranslationEntityImpl updateItemTranslation = enrichmentTranslationService.updateItemTranslation(storyId, itemId, body);
         ...
         * @throws Exception 
         */
        @ApiOperation(value = "Submit corrected translation text for Stories", nickname = "updateStoryTranslation", 
                notes = "This method updates the translation of textual information available in transcribathon documents. \"storyId\" represents the identifier of the document in Transcribathon platform.\n" + 
        ...
        public ResponseEntity<String> updateStoryTranslation(
                @PathVariable("storyId") String storyId,
                @RequestBody TranslationUpdateRequest  body,
                HttpServletRequest request) throws Exception {
                ...
                TranslationEntityImpl updateItemTranslation = enrichmentTranslationService.updateStoryTranslation(storyId, body);
