...
public class TranslationController extends BaseRest {
	...
	/**
         ...
         * @throws Exception 
         */
        @ApiOperation(value = "Submit corrected translation text for Items", nickname = "updateTranslationItem", 
                notes = "This method updates the translation of textual information available in transcribathon documents. \"storyId\" represents the identifier of the document in Transcribathon platform.\n" + 
                        " The parameter \"itemId\" further enables considering only specific story item. " +
                        " The \"property\" parameter indicates the property which holds the original text, supported values: \"summary\", \"description\" and \"transcription\".\n"  
                        )
        @PutMapping(value = "/enrichment/translation/", produces = MediaType.TEXT_PLAIN_VALUE)
        public ResponseEntity<String> updateTranslationItem(
                ...
                validateTranslationParams(body.getStoryId(), body.getItemId(), body.getTranslationTool(), body.getProperty(), true);
                ...
                TranslationEntityImpl updateItemTranslation = enrichmentTranslationService.updateItemTranslation(body);
